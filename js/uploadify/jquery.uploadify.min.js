        ...
        init: function (d, e) {
            return this.each(function () {
                ...
                if (h) {
                    ...
                    n.data("uploadify", i);
                    /*var l=c("<div />",{id:j.id,"class":"uploadify",css:{height:j.height+"px",width:j.width+"px"}});c("#"+i.movieName).wrap(l);*/
                    c("#" + i.movieName).parent().addClass("uploadify").attr("id", j.id).css({
                        height: j.height + "px",
                        width: j.width + "px"
                    });
                    l = c("#" + j.id);
                    ...
                    l.append(f);
                    c("#" + i.movieName).css({position: "absolute", "z-index": 1, "opacity": 0});
                    if (!j.queueID) {
