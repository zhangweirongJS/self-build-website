  ...
  nav: {
    typeEdit: {
      ...
      fn: function(o, mId, da) {
        parWin.Ev.admin.tj.v.curEditObjId = mId;
        parWin.Ev.admin.tj.v.curEditObj = o;
        DF.f.openPopup("设计导航样式", '/VNew/css_style.php?tag=' + mId);
      }
    },
    createColumn: {
      text: "增加栏目",
      ...
      fn: function(o, mId, da) {
        ...
        parWin.Ev.admin.openAddChannel('/VNew/tj/copyChannel.php?c_id=1');
      }
    },
    columnAdmin: {
      text: "栏目管理",
      ...
      fn: function(o, mId, da) {
        ...
        parWin.Ev.admin.openAddChannel('/VNew/column_list.php');
        // parWin.Ev.pubVar.winDocum.find("#toolColumn").trigger("click");
      }
    },
    columnEdit: {
